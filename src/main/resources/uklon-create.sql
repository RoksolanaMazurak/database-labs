...
INSERT INTO client (id, surname, name, phone, email, city, street_address,  client_card_id) VALUES
(1, 'Klymenko', 'Oleksandra', '0980618738', 'klymenko.sasha@gmail.com', 'Lviv', 'Baturynska street, 58', 1),
(2, 'Melnyk', 'Pavlo', '0930818730', 'klymenko.sasha@gmail.com', 'Ivano-Frankivsk', 'Trusha Street, 2c', 1),
(3, 'Havrylyuk', 'Andrii', '0951518739', 'havrylyuk.andrii@gmail.com', 'Chernivtsi', 'Shevchenko street, 21', 1),
(4, 'Boyko', 'Oksana', '0674518721', 'boyko.oksana@gmail.com', 'Lviv', 'Kolisna, 12', 2),
(5, 'Karpenko', 'Olga', '0988918702', 'karpenko.olga@gmail.com', 'Ivano-Frankivsk', 'Zaklynskykh Street, 4', 1),
(6, 'Rudenko', 'Maria', '0991258782', 'rudenko.maria@gmail.com', 'Lviv', 'Svitankova, 1a', 1),
(7, 'Lysenko', 'Mykola', '0930868737', 'lysenko.mykola@gmail.com', 'Chernivtsi', 'Holovna street, 14', 2),
(8, 'Polishchuk', 'Nazar', '0990618963', 'polishchuk.nazik@gmail.com', 'Ivano-Frankivsk', 'Makohona Street, 1b', 2),
(9, 'Kovalenko', 'Oleg', '067051871', 'kovalenko.oleg@gmail.com', 'Lviv', 'Yaroslava Mudroho, 5', 2),
(10, 'Shevchenko', 'Natalia', '0985211722', 'shevchenko.natalia@gmail.com', 'Ivano-Frankivsk', 'Karpatska Street, 25', 2);
...
INSERT INTO driver (id, surname, name, gender, rating_id, car_id) VALUES
(1, 'Savchenko', 'Oleg', 'male', 3, 1),
(2, 'Shevchuk', 'Ivan', 'male', 2, 2),
(3, 'Tkachuk', 'Oleksandr', 'male', 5, 3),
(4, 'Kravchuk', 'Bogdana', 'female', 10, 4),
(5, 'Boychuk', 'Yana', 'female', 4, 5),
(6, 'Kharchenko', 'Vasyl', 'male', 9, 6),
(7, 'Ponomarenko', 'Olena', 'female', 6, 7),
(8, 'Kuzmenko', 'Nazarii', 'male', 8, 8),
(9, 'Sydorenko', 'Oksana', 'female', 7, 9),
(10, 'Kovalenko', 'Viktoria', 'female', 1, 10);
...
CREATE INDEX driver_surname_index ON driver(surname);
CREATE INDEX car_name_index ON car_model(name);
